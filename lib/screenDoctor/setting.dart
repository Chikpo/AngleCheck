...
import 'package:newwieproject/screenDoctor/editdata.dart';
          ...
          children: [
            ...
            FilledButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const DoctorEdit()));
                // print("Edit");
              },
            ...
            Padding(
              ...
              child: OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                      side: const BorderSide(
                          color: Color.fromRGBO(92, 86, 86, 0.165), width: 2.5),
