...
class UserExer extends StatefulWidget {
  const UserExer({super.key});

  @override
  _UserExerState createState() => _UserExerState();
}

class _UserExerState extends State<UserExer> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/vdo/cva.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
  }
